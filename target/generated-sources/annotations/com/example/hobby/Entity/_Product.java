...
/** */
@javax.annotation.processing.Generated(value = { "Doma", "2.58.0" }, date = "2026-07-15T18:31:07.908+0900")
...
public final class _Product extends org.seasar.doma.jdbc.entity.AbstractEntityType<com.example.hobby.Entity.Product> {
    ...
    private _Product() {
        ...
        java.util.List<org.seasar.doma.jdbc.entity.EntityPropertyType<com.example.hobby.Entity.Product, ?>> __list = new java.util.ArrayList<>(6);
        java.util.Map<String, org.seasar.doma.jdbc.entity.EntityPropertyType<com.example.hobby.Entity.Product, ?>> __map = new java.util.LinkedHashMap<>(6);
        java.util.Map<String, org.seasar.doma.jdbc.entity.EmbeddedPropertyType<com.example.hobby.Entity.Product, ?>> __embeddedMap = new java.util.LinkedHashMap<>(6);
    ...
    private void initializeMaps(java.util.Map<String, org.seasar.doma.jdbc.entity.EntityPropertyType<com.example.hobby.Entity.Product, ?>> __map, java.util.Map<String, org.seasar.doma.jdbc.entity.EmbeddedPropertyType<com.example.hobby.Entity.Product, ?>> __embeddedMap) {
        __map.put("orderId", new org.seasar.doma.jdbc.entity.AssignedIdPropertyType<com.example.hobby.Entity.Product, java.lang.String, java.lang.String>(com.example.hobby.Entity.Product.class, org.seasar.doma.internal.jdbc.scalar.BasicScalarSuppliers.ofString(), "orderId", "order_id", __namingType, false));
        __map.put("memberCode", new org.seasar.doma.jdbc.entity.DefaultPropertyType<com.example.hobby.Entity.Product, java.lang.String, java.lang.String>(com.example.hobby.Entity.Product.class, org.seasar.doma.internal.jdbc.scalar.BasicScalarSuppliers.ofString(), "memberCode", "member_code", __namingType, true, true, false));
        __map.put("orderDate", new org.seasar.doma.jdbc.entity.DefaultPropertyType<com.example.hobby.Entity.Product, java.lang.String, java.lang.String>(com.example.hobby.Entity.Product.class, org.seasar.doma.internal.jdbc.scalar.BasicScalarSuppliers.ofString(), "orderDate", "order_date", __namingType, true, true, false));
        __map.put("shippingDate", new org.seasar.doma.jdbc.entity.DefaultPropertyType<com.example.hobby.Entity.Product, java.lang.String, java.lang.String>(com.example.hobby.Entity.Product.class, org.seasar.doma.internal.jdbc.scalar.BasicScalarSuppliers.ofString(), "shippingDate", "shipping_date", __namingType, true, true, false));
        __map.put("status", new org.seasar.doma.jdbc.entity.DefaultPropertyType<com.example.hobby.Entity.Product, java.lang.String, java.lang.String>(com.example.hobby.Entity.Product.class, org.seasar.doma.internal.jdbc.scalar.BasicScalarSuppliers.ofString(), "status", "status", __namingType, true, true, false));
        __map.put("totalPrice", new org.seasar.doma.jdbc.entity.DefaultPropertyType<com.example.hobby.Entity.Product, java.lang.String, java.lang.String>(com.example.hobby.Entity.Product.class, org.seasar.doma.internal.jdbc.scalar.BasicScalarSuppliers.ofString(), "totalPrice", "total_price", __namingType, true, true, false));
    }
